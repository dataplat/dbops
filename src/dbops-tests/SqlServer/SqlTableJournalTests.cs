...
{
    public class SqlTableJournalTests
    {

        public class upgrade_table_when_version_mismatch : SpecificationFor<SqlTableJournal>
        {
            IDbConnection dbConnection;
            IDbCommand dbCommand;
            CaptureLogsLogger log;

            public override SqlTableJournal Given()
            {
                ...
                var versionTracker = new SqlTableJournal(() => connectionManager, () => log, null, "history");
