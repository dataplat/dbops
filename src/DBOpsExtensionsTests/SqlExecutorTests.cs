...
namespace DBOps.Tests.Extensions
{
    public class SqlScriptExecutorTests
    {
        ...
        {
            var executor = new SqlScriptExecutor(() => Substitute.For<IConnectionManager>(), () => null, null, () => false, null, () => Substitute.For<DbUp.Engine.IJournal>());
        ...
        public void when_schema_is_null_schema_is_stripped_from_scripts()
        {
            ...
            var executor = new SqlScriptExecutor(() => new TestConnectionManager(dbConnection, true), () => new ConsoleUpgradeLog(), null, () => true, null, () => Substitute.For<DbUp.Engine.IJournal>());
        ...
        public void does_not_use_variable_subtitute_preprocessor_when_setting_false()
        {
            ...
            var command = Substitute.For<IDbCommand>();
            dbConnection.CreateCommand().Returns(command);
            var executor = new SqlScriptExecutor(() => new TestConnectionManager(dbConnection, true), () => new ConsoleUpgradeLog(), null, () => false, null, () => Substitute.For<DbUp.Engine.IJournal>());
        ...
        public void uses_variable_subtitutes_schema()
        {
            ...
            var command = Substitute.For<IDbCommand>();
            dbConnection.CreateCommand().Returns(command);
            var executor = new SqlScriptExecutor(() => new TestConnectionManager(dbConnection, true), () => new ConsoleUpgradeLog(), "foo", () => true, null, () => Substitute.For<DbUp.Engine.IJournal>());
        ...
        public void logs_when_dbexception()
        {
            ...
            var executor = new SqlScriptExecutor(() => new TestConnectionManager(dbConnection, true), () => logger, null, () => true, null, () => Substitute.For<DbUp.Engine.IJournal>());
