function Install-NugetPackage {
    ...
    $index = Invoke-WebRequest "$Api/index.json" -ErrorAction Stop -WhatIf:$false
    ...
    $packageInfoResponse = Invoke-WebRequest -Uri "$($searchUrl.'@id')$query" -ErrorAction Stop -WhatIf:$false
